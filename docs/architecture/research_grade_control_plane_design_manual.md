...
`promotion_decisions.jsonl`.  The Trial ledger and JSONL files are
candidate/screening/promotion records only; they do not establish final trust
without Step3/Step4 evidence.
...
`architecture_candidate_set.json`, `mapping_candidates.jsonl`,
