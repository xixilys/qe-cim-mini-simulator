...
DSE (Design Space Exploration) framework, workload analysis scripts, baseline acquisition tools, and validation infrastructure for the DFT acceleration system.
...
- **50+ Python scripts**: DSE framework, validation tools, analysis scripts
...
### DSE and Architecture Exploration
...
### Baseline Acquisition and Validation
...
### Evidence Closure and Reporting
...
python3 docs/benchmarks/qe_ic_graph_projection_utils.py \
  --graph-spec docs/architecture/qe_ic_graph_seed_system_level_v1.json \
  --preview
```
...
python3 docs/benchmarks/test_check_qe_ic_component_graph_v1.py

# Projection utils
python3 docs/benchmarks/test_qe_ic_graph_projection_utils.py

# Evidence closure
python3 docs/benchmarks/test_assess_qe_phase1_evidence_closure.py

# Baseline readiness
python3 docs/benchmarks/test_assess_qe_cpu_gpu_baseline_readiness.py
```
...
- `run_*.py` - Executable entry points
- `check_*.py` - Validation scripts
- `test_*.py` - Regression tests
- `assess_*.py` - Assessment tools
- `analyze_*.py` - Analysis scripts
- `build_*.py` - Builder utilities
