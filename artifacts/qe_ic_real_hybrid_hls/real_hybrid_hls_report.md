...
- Best architecture: `hybrid_integrated_streaming_pipeline_sidecar_v3`
- Best optimistic trace-replay speedup vs GPU: `1.55089x`
...
- `hybrid_nonlocal_projector_accumulator_v1`
  - Coverage: `qe_routine_equivalent_miniapp`; mapped timers: `h_psi, h_psi:calbec, calbec`
  - C-sim golden: `True`
  - C-synth parsed: `partial`, latency `None` cycles, estimated clock `8.75` ns
  - Verilog C/RTL cosim: `True`, latency `4105` cycles
  - VCS RTL sim: `True`, latency `256` cycles, samples `256`
  - Performance latency source: `vivado_hls_cosim`, latency `4105` cycles
  - Resource feasible on target: `True`; BRAM18K `24`, DSP `26`, FF `8373`, LUT `9685`, URAM `0`
  - HLS blockers: `hls_latency_summary_missing`
...
| `hybrid_nonlocal_projector_accumulator_v1` | `ic_sio2_dielectric_6atom_scf_v0` | `vivado_hls_cosim` | `h_psi, h_psi:calbec, calbec` | 1.1084x | `trace_replay_optimistic` | `qe_routine_equivalent_miniapp` |
| `hybrid_nonlocal_projector_accumulator_v1` | `ic_sio2_dielectric_6atom_scf_v0` | `vcs_rtl` | `h_psi, h_psi:calbec, calbec` | 1.1199x | `trace_replay_vcs_rtl_sensitivity` | `qe_routine_equivalent_miniapp` |
| `hybrid_nonlocal_projector_accumulator_v1` | `ic_al_interconnect_4atom_scf_v0` | `vivado_hls_cosim` | `h_psi, h_psi:calbec, calbec` | 1.2560x | `trace_replay_optimistic` | `qe_routine_equivalent_miniapp` |
| `hybrid_nonlocal_projector_accumulator_v1` | `ic_al_interconnect_4atom_scf_v0` | `vcs_rtl` | `h_psi, h_psi:calbec, calbec` | 1.2714x | `trace_replay_vcs_rtl_sensitivity` | `qe_routine_equivalent_miniapp` |
| `hybrid_nonlocal_projector_accumulator_v1` | `ic_si_bulk_2atom_scf_v0` | `vivado_hls_cosim` | `h_psi, h_psi:calbec, calbec` | 1.2104x | `trace_replay_optimistic` | `qe_routine_equivalent_miniapp` |
| `hybrid_nonlocal_projector_accumulator_v1` | `ic_si_bulk_2atom_scf_v0` | `vcs_rtl` | `h_psi, h_psi:calbec, calbec` | 1.2220x | `trace_replay_vcs_rtl_sensitivity` | `qe_routine_equivalent_miniapp` |
...
Integrated Vivado implementation evidence for the II=1 streaming RTL sidecar; not physical board measurement or full QE kernel integration. Current conclusion remains bounded by full QE kernel integration and physical FPGA board measurement gates.
