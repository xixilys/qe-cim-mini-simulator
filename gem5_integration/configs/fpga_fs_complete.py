...
# Match gem5's standard x86 FS metadata tables.
...
# Boot command - kernel will load initramfs from memory
...
print("=" * 60)
print("gem5 FS Mode - PC Platform + FPGA Device")
print("=" * 60)
...
print(f"Console: m5out/system.pc.com_1.device")
print(f"Max ticks: {max_ticks}")
print("=" * 60)

# Simulate long enough for x86 Linux boot progress.
