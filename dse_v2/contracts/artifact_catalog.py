...
ARTIFACT_CATALOG: tuple[ArtifactDefinition, ...] = (
    ...
    _definition(
        ...
        ("ledger", "step2", "step3"),
        {
            ...
            "workload_run_id": "workload-run-001",
            "trial_id": "trial-001",
            "plan_id": "campaign-search-admission-001",
            "status": "active",
            ...
            "step3_simulation_queue_ref": "step2/step3_simulation_queue.json",
            "search_iteration_applied_feedback_count": 1,
            "next_candidate_count": 2,
            "existing_step3_queue_entry_count": 1,
            "already_materialized_candidate_count": 1,
            ...
            "release_completion_eligible": False,
            "trusted_final_claim": False,
            "claim_boundary": "search admission planning is fail-closed until Step2 writes canonical Step3 queue entries",
            "resume_next_actions": [
                "run Step2 materialization before Step3",
                "do not execute deferred candidates without an explicit widened Campaign budget",
            ],
        },
    ),
    _definition(
        ...
        ("control_plane", "step2", "step4", "ledger"),
        {
            ...
            "next_candidates": [
                {
                    ...
                    "parameter_hash": "sha256:candidate-002",
                    "provenance": {"policy_name": "workflow_seeded_beam_local_search_v1"},
                }
            ],
            "feedback_influence_summary": {
                ...
                "trusted_final_claim": False,
                "release_completion_eligible": False,
                "claim_boundary": "control-plane feedback scheduling evidence only",
            },
            "top_k_queue_provenance_only": True,
            "hidden_evidence_fanout_allowed": False,
            "trusted_final_claim": False,
            ...
            "claim_boundary": (
                ...
                "not Step3 execution authority."
            ),
        },
        required=False,
    ),
    _definition(
        "search_feedback_closure_audit.json",
        "control_plane",
        ...
        ("step2", "step5", "ledger"),
        {
            **_SCOPE,
            ...
            "source_run_dir": "runs/search_round_01",
            "out_dir": "runs/search_round_02",
            "loop_artifacts": {
            ...
            "campaign_deferred_candidate_count": 0,
            "global_checks": {
                "executed_rows_have_feedback": True,
                "feedback_applied_to_search_iteration": True,
                "observed_feedback_classified_by_campaign": True,
                "hidden_evidence_fanout_allowed": False,
            ...
            "trusted_final_claim": False,
            "release_completion_eligible": False,
            "claim_boundary": "Search feedback closure is control-plane lineage evidence only.",
        },
        required=False,
    ),
    _definition(
        "search_replay_safety_audit.json",
        "control_plane",
        ...
        ("step2", "step5", "ledger"),
        {
            **_SCOPE,
            ...
            "observed_feedback_classification": [
                {
                    ...
                    "re_requested_by_campaign": False,
                    "blockers": [],
                }
            ],
            "campaign_request_lineage": [
                {
                    "candidate_id": "candidate-002",
                    "request_parameter_hash": "sha256:candidate-002",
                    "matched_search_candidate_id": "candidate-002",
                    "blockers": [],
                }
            ],
            "source_search_iteration_plan_safety": {"status": "safe"},
            "global_checks": {
                "observed_feedback_not_re_requested": True,
                "rejected_feedback_not_re_requested": True,
                "rejected_feedback_deferred": True,
                "all_campaign_requests_target_unobserved_candidates": True,
                "all_campaign_requests_safe": True,
                "campaign_source_search_iteration_plan_safe": True,
                "hidden_evidence_fanout_allowed": False,
                "execution_allowed": False,
                "trusted_final_claim": False,
                "release_completion_eligible": False,
            ...
            "trusted_final_claim": False,
            "release_completion_eligible": False,
            "claim_boundary": "Search replay safety is control-plane budget discipline evidence only.",
        },
        required=False,
    ),
    _definition(
        "search_loop_audit_summary.json",
        "control_plane",
        ...
        ("step5", "ledger"),
        {
            ...
            "run_count": 0,
            "closure_audit_count": 0,
            "replay_safety_audit_count": 0,
            "missing_closure_audit_count": 0,
            "missing_replay_safety_audit_count": 0,
            "closure_closed_count": 0,
            "replay_safety_closed_count": 0,
            "per_run_blocker_count": 0,
            "total_blocker_count": 0,
            "all_closure_closed": False,
            "all_replay_safe": False,
            "all_global_checks_safe": False,
            "cross_run_replay_safe": False,
            "cross_run_blocker_count": 0,
            "cross_run_blockers": [],
            "progression_safe": False,
            "progression_blocker_count": 0,
            "progression_blockers": [],
            "effective_round_count": 0,
            "new_candidate_execution_count": 0,
            "candidate_progression_count": 0,
            "request_to_execution_progression_count": 0,
            "feedback_influence_audit_count": 0,
            "feedback_influence_safe": False,
            "all_feedback_influence_effective": False,
            "execution_allowed": False,
            "hidden_evidence_fanout_allowed": False,
            "trusted_final_claim": False,
            "release_completion_eligible": False,
            "entries": [],
            "claim_boundary": "Search loop summaries are audit evidence only.",
        },
        required=False,
    ),
    _definition(
        "search_effectiveness_audit.json",
        "control_plane",
        ...
        ("step5", "ledger"),
        {
            ...
            "contract_version": CONTRACT_VERSION,
            "status": "partial_blocked_not_complete",
            "run_dir": "runs/search_round_02",
            "architecture_search_coverage_ref": "step2/architecture_search_space.json",
            "campaign_search_admission_plan_ref": "campaign_search_admission_plan.json",
            "campaign_materialization_summary_ref": "campaign_materialization_summary.json",
            "materialization_coverage_audit_ref": "",
            "search_loop_audit_summary_ref": "search_loop_audit_summary.json",
            "coverage_effective": False,
            "campaign_admission_safe": False,
            "materialization_coverage_closed": False,
            "search_progression_safe": False,
            "candidate_progression_effective": False,
            "candidate_parameter_progression_effective": False,
            "request_to_execution_progression_effective": False,
            "step3_admission_safe": False,
            "search_effective": False,
            "effectiveness_gate_passed": False,
            "search_loop_present": False,
            "effective_round_count": 0,
            "candidate_progression_count": 0,
            "candidate_progression_parameter_hash_count": 0,
            "candidate_progression_parameter_hashes": [],
            "blocker_count": 1,
            "blockers": [{"reason_id": "example_partial_not_complete"}],
            "execution_allowed": False,
            "hidden_evidence_fanout_allowed": False,
            "trusted_final_claim": False,
            "release_completion_eligible": False,
            "deliverable_complete": False,
            "claim_boundary": "Search effectiveness audits are control-plane checks only.",
        },
        required=False,
    ),
    _definition(
