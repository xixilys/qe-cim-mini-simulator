        ...
        for workload_case_id in workload_case_ids:
            ...
            rows.append({
                ...
                "required_outputs": {
                    ...
                    "accelerated_output_json": str(row_dir / "accelerated_output.json"),
                    "accelerated_output_data": str(row_dir / "accelerated_output.bin"),
                    "consumption_proof_json": str(row_dir / "qe_consumption_proof.json"),
                    "full_scf_runtime_events_jsonl": str(row_dir / "full_scf_runtime_events.jsonl"),
                ...
                "target_kernel_evidence_requirements": {
                    ...
                    "requires_qe_post_bridge_consumption_proof": True,
                    "requires_consumed_output_buffer_hash_match": True,
                ...
                "consumption_proof_merge_command_template": [
                    sys.executable,
                    "dse_v2/scripts/dse/merge_qe_consumption_proof.py",
                    "--consumption-proof",
                    str(row_dir / "qe_consumption_proof.json"),
                    "--kernel-evidence",
                    str(row_dir / "kernel_evidence.json"),
                    "--offload-provenance",
                    str(row_dir / "offload_provenance.json"),
                    ...
                    str(row_dir / "accelerated_output.bin"),
                    "--runtime-events",
