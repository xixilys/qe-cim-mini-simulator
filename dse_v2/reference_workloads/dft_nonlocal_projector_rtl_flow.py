...
def write_nonlocal_projector_rtl_sources(
    out_dir: Path,
    *,
    ...
    _write_text(
        out_dir / files["rtl"],
        parametrize_rtl_source(NONLOCAL_PROJECTOR_KERNEL_ID, NONLOCAL_PROJECTOR_VERILOG, candidate_parameter_manifest),
    )
...
def initialize_nonlocal_projector_rtl_flow(
    out_dir: Path,
    *,
    ...
    source_files = write_nonlocal_projector_rtl_sources(out_dir, candidate_parameter_manifest=candidate_parameters)
