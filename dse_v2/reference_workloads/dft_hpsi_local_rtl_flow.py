...
def write_hpsi_local_rtl_sources(
    out_dir: Path,
    *,
    ...
    _write_text(
        out_dir / files["rtl"],
        parametrize_rtl_source(HPSI_LOCAL_KERNEL_ID, HPSI_LOCAL_VERILOG, candidate_parameter_manifest),
    )
...
def initialize_hpsi_local_rtl_flow(
    out_dir: Path,
    *,
    ...
    source_files = write_hpsi_local_rtl_sources(out_dir, candidate_parameter_manifest=candidate_parameters)
