...
def write_transpose_layout_rtl_sources(
    out_dir: Path,
    *,
    ...
    _write_text(
        out_dir / files["rtl"],
        parametrize_rtl_source(TRANSPOSE_LAYOUT_KERNEL_ID, TRANSPOSE_LAYOUT_VERILOG, candidate_parameter_manifest),
    )
...
def initialize_transpose_layout_rtl_flow(
    out_dir: Path,
    *,
    ...
    source_files = write_transpose_layout_rtl_sources(out_dir, candidate_parameter_manifest=candidate_parameters)
