...
def _load_step2_handoff(step2_dir: Path) -> Dict[str, Any]:
    return {
        ...
        "search_checkpoint": _load_json(step2_dir / "search_checkpoint.json"),
        "top_k_candidate_queue": _load_json(step2_dir / "top_k_candidate_queue.json"),
...
def validate_step2_handoff_for_step3(step2_dir: Path) -> Dict[str, Any]:
    ...
    dynamic_validation = validate_step2_artifacts({
        ...
        "search_checkpoint": handoff["search_checkpoint"],
        "top_k_candidate_queue": handoff["top_k_candidate_queue"],
